        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Password = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    NewsOn = table.Column<bool>(type: "bit", nullable: false),
                    LaRenzaPoints = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Bage = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Colors_Comments_CommentId",
                        column: x => x.CommentId,
                        principalTable: "Comments",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Colors_OrderItems_OrderItemId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Sizes_Comments_CommentId",
                        column: x => x.CommentId,
                        principalTable: "Comments",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Sizes_OrderItems_OrderItemId",
                        column: x => x.OrderItemId,
                        principalTable: "OrderItems",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Colors_CommentId",
                table: "Colors",
                column: "CommentId");

            migrationBuilder.CreateIndex(
                name: "IX_Colors_OrderItemId",
                table: "Colors",
                column: "OrderItemId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Sizes_CommentId",
                table: "Sizes",
                column: "CommentId");

            migrationBuilder.CreateIndex(
                name: "IX_Sizes_OrderItemId",
                table: "Sizes",
                column: "OrderItemId");
        }
